...
```
country_capital = {'Germany':'Berlin', 'Brazil':'Brasilia', 'Budapest':'Hungary','China':'Beijing', 'India':'New Dehli', 'Norway':'Oslo', 'France':'Paris', 'Indonesia': 'Jakarta','USA':'Washington'}
capital['Capital'] = df['Country'].map(country_capital)
```
